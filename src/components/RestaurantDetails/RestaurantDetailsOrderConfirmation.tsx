...
import styles from './RestaurantDetailsOrderConfirmation.module.scss';
...
export default function RestaurantListOrderConfirmation({
	isOpen,
	isLoading = false,
	onCancel,
	onAccept,
	...
	return (
		...
		>
			<div className={styles.root}>
				...
				<LocalizationProvider dateAdapter={AdapterDayjs} className={styles.dateSection}>
